        ...
        try
        {
          ...
          var excludedPlugins = Settings.Current.Plugins
            ...
            .ToArray();
                    ...
                    var nick = "Server";
                    var color = Color.Red;
                    var address = "93.170.186.160:10021";
                    ...
                    var initializer = new ClientInitializer
                    {
                        ...
                        //TrustedCertificatesPath = "E:\\5th Semester\\CN Lab\\Project\\Abdullah Farooq\\c.pfx",
          ...
          var serverUri = Connection.CreateTcpchatUri(address);
          ClientModel.Client.Connect(serverUri);
                    Settings.Current.Nick = nick;
                    Settings.Current.NickColor = color;
